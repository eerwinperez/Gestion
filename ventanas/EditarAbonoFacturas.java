 ...
 * @author erwin
 */
public class EditarAbonoFacturas extends javax.swing.JFrame {

    String usuario, permiso, cliente, idAbono, observaciones, factura;
    Date fecha;
    Object abono;
    String[] datos;
     ...
     */
    public EditarAbonoFacturas() {
        initComponents();
    }

    public EditarAbonoFacturas(String usuario, String permiso, String cliente, String idAbono, Object abono, String observaciones, Date fecha, String factura) {
    ...
    public void CargarDatosEnFormulario() {
        ...
        jDateChooser1.setDate(this.fecha);
    ...
    public void EditarAbono(String idAbono, Object valor, String observaciones, String fecha) {
        String consulta = "update abonosfacturas set abono=?, fecha=?, observaciones=? where idAbono=?";
        ...
        try {
            ...
            String fecha2 = new SimpleDateFormat("yyyy-MM-dd").format(this.fecha);

            String asunto = "Abono " + this.idAbono + " editado - Empresas";
            String mensaje = "El abono No. " + this.idAbono + " ha sido editado"
                    + "\nValor anterior = " + MetodosGenerales.ConvertirIntAMoneda((Double) this.abono)
                    + "- nuevo valor = " + MetodosGenerales.ConvertirIntAMoneda((Double) valor)
                    + "\nFecha anterior = " + fecha2 + " - nueva fecha = " + fecha
    ...
    public boolean consultaMontos(String factura, Double nuevoAbono, Double AbonoActual) {

        String consulta = "SELECT monto FROM facturas WHERE idFactura=?";
        String consulta2 = "select sum(abono) as total from abonosfacturas where factura=?";
        Connection cn = Conexion.Conectar();
        ...
        try {
            ...
            if (rs.next()) {
                montoFactura = rs.getDouble("monto");
            }
            ...
            if (rs2.next()) {
                totalAbonos = rs2.getDouble("total");
            }

            cn2.close();

            if ((totalAbonos - AbonoActual + nuevoAbono <= montoFactura) && montoFactura != 0 && totalAbonos != 0) {
                return true;
            }

        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al consultar el monto de la factura");
            e.printStackTrace();
        }
    ...
    private void jButton_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_editarActionPerformed
        ...
        Object valor = Double.parseDouble(jTextField_valor.getText().trim());
        if (!valor.equals("")) {
            try {
                ...
                double valorActual = (Double) this.abono;
                ...
                if (opcion == 0) {
                    boolean comprobacion = consultaMontos(this.factura, (Double) valor, valorActual);
                    if (comprobacion) {
                ...
                JOptionPane.showMessageDialog(this, "Fecha o abono incorrectos", "Error", JOptionPane.ERROR_MESSAGE);
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarAbonoFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarAbonoFacturas().setVisible(true);
            }
        });
    }
