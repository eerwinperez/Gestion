 ...
 * @author erwin
 */
public class SeleccionClienteParaCargarVentaDeLista extends javax.swing.JFrame {
     ...
     */
    public SeleccionClienteParaCargarVentaDeLista() {
        initComponents();
    ...
    public SeleccionClienteParaCargarVentaDeLista(String usuario, String permiso) {
        initComponents();
    ...
    public SeleccionClienteParaCargarVentaDeLista(String usuario, String permiso, String idPedido) {
        initComponents();
        this.usuario = usuario;
        this.permiso = permiso;
    ...
    private void jButton_cargarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_cargarVentaActionPerformed
        ...
        if (!nombreCliente.equals("")) {
            ...
            new RegistroVentas(usuario, permiso, nombreCliente, idPedido, "").setVisible(true);
            dispose();
        } else {
            if (!cedulaNIT.equals("")) {
                ...
                if (!Cliente.equals("")) {
                    ...
                    new RegistroVentas(usuario, permiso, Cliente, idPedido, "").setVisible(true);
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionClienteParaCargarVentaDeLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionClienteParaCargarVentaDeLista().setVisible(true);
            }
        });
    }
