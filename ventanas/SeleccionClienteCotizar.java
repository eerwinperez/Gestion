 ...
 * @author erwin
 */
public class SeleccionClienteCotizar extends javax.swing.JFrame {
     ...
     */
    public SeleccionClienteCotizar() {
        initComponents();
    ...
    public SeleccionClienteCotizar(String usuario, String permiso) {
        initComponents();
    ...
    public SeleccionClienteCotizar(String usuario, String permiso, String idPedido) {
        initComponents();
        this.usuario = usuario;
        this.permiso = permiso;
    ...
    private void initComponents() {
        ...
        jButton_cargarVenta.setText("Cargar cotizacion");
    ...
    private void jButton_cargarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_cargarVentaActionPerformed
        ...
        if (!nombreCliente.equals("")) {
            ...
            new RegistroCotizacion(usuario, permiso, nombreCliente).setVisible(true);
            dispose();
        } else {
            if (!cedulaNIT.equals("")) {
                ...
                if (!Cliente.equals("")) {
                    ...
                    new RegistroCotizacion(usuario, permiso, Cliente).setVisible(true);
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionClienteCotizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionClienteCotizar().setVisible(true);
            }
        });
    }
