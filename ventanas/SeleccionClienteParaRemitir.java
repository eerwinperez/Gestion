...
public class SeleccionClienteParaRemitir extends javax.swing.JFrame {
    ...
    public void llenarJComboBox() {
        ...
        try {
            String consulta = "select distinct c.nombreCliente\n"
                    + "from vistaremitir v join clientes c on v.Idcliente=c.idCliente\n"
            ...
            while (rs.next()) {
                String cliente = rs.getString("c.nombreCliente");
    ...
    private void jButton_cargarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_cargarVentaActionPerformed
        ...
        if (!nombreCliente.equals("")) {
            ...
            new ListadoParaRemitir(usuario, permiso, idCliente).setVisible(true);
            dispose();
        } else {
            if (!cedulaNIT.equals("")) {
                ...
                if (!Cliente.equals("")) {
                    ...
                    JOptionPane.showMessageDialog(null, "El NIT/Cedula ingresado no se encuentra registrado en la base de datos","Error",JOptionPane.ERROR_MESSAGE);
                }
            } else {
